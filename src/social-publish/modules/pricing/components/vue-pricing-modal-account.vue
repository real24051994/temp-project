<template>
	<a-modal transitionName="none" maskTransitionName="none" :centered="true" v-model="visible"  :destroyOnClose="true" :title="false" :footer="false" width="900px" class="vue-pricing-modal" :afterClose="afterClose">
			...
			<div class="vue-pricing-modal-content">
				<div class="content-inner">
					<div class="content-header">
						...
						<div class="content-title">You have reach the plan’s limit number of social account</div>
						<div class="content-description">Please upgrade your plan to have the best service</div>
						<div class="content-upgrade">
							<a-button v-if="trial" type="primary" @click="onClick" class="btn-track-event btn-event-pricing" data-position="modal-account" data-status="start-trial">
								Start free trial
							</a-button>
							<a-button v-else type="primary" @click="onClick" class="btn-track-event btn-event-pricing" data-position="modal-account" data-status="upgrade">
