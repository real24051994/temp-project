<template>
	<a-button  class="m-w-150" @click="onClick()" :loading="is_loading">
		Login to Bit.ly
	</a-button>
</template>
<script>
...
export default {
	...
	methods:{
		...mapActions({
			'generalBitlyUrl' : 'setting/generalBitlyUrl',
		}),
		onClick(){
			if( this.is_loading ) return ;
			this.is_loading = true 
			popup = window.open ( '' ,"Social Publish","menubar=1,resizable=1,width=900,height=500");
