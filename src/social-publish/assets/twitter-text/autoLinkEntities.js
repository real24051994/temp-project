...
const DEFAULT_USERNAME_CLASS = 'social-publish username';
// Default CSS class for auto-linked hashtags (along with the url class)
const DEFAULT_HASHTAG_CLASS = 'social-publish hashtag';
// Default CSS class for auto-linked cashtags (along with the url class)
const DEFAULT_CASHTAG_CLASS = 'social-publish cashtag';

const DEFAULT_URL_CLASS = 'social-publish link';
