<template>
	<div class="shop-onboard-layout">
		<div class="shop-onboard-layout-content">
			<div class="shop-onboard-layout-header">
				<div class="icon-logo">
					<img src="@shop/assets/icons/icon-socialshop.svg" svg-inline alt="">
				</div>
			</div>
			<div class="shop-onboard-layout-body">
				<transition name="fade-in" mode="out-in">
					<router-view />
				</transition>
			</div>
		</div>
		<div class="shop-onboard-layout-aside">
			<div class="shop-onboard-layout-aside-header">
				<div class="shop-onboard-user" v-if="user && avatar">
					...
					<a-drawer :visible="visible" @close="visible = false" width="360px" :destroyOnClose="true" :title="false" wrapClassName="shop-onboard-user-drawer">
						<vue-simple class="shop-onboard-user-drawer-scrollbar">
							<div class="shop-onboard-user-drawer-wrapper">
								<div class="shop-onboard-user-drawer-header">
									<div class="user-info">
								...
								<div class="shop-onboard-user-drawer-body">
									<div class="shop-onboard-user-drawer-body-scrollbar">
										<slot name="toolbar-user"></slot>
									</div>
								</div>
								<div class="shop-onboard-user-drawer-footer">
			...
			<div class="shop-onboard-layout-aside-body">
				<div class="shop-onboard-layout-aside-content">
					<img src="@shop/assets/icons/onboarding-banner.svg" alt="">
					<h3>
						Multiple social channel product feed manager
					</h3>
				</div>
			</div>
		</div>
...
<style lang="scss">
	.shop-onboard-layout{
		...
		&-aside{
			...
			width: 420px;
			z-index: 1;
			background: linear-gradient(181.62deg, rgba(255, 255, 255, 0.56) 12.9%, rgba(255, 255, 255, 0.2) 108.61%), #CCDCFF;
			height: 100vh;
			&-header{
				height: 70px;
				display: flex;
