...
i18n.mergeLocaleMessage('en', {
	"auth" :{
		...
		"heading" : {
			"forget_password" : "Fogot Password? <br>Please fill your email to get it back",
			"merge_account" : "Take a moment to create your first password for next time login",
			"login" : "Connect your store to the social media management tool",
			"register" : "Connect your store to the social media management tool",
			"reset_password" : "Create new password",
			"send_email_success" : "We have sent a <br> Reset Password Email to your email",
