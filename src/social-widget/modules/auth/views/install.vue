			...
			<div class="col col-12">
				<div class="vue-app-install-page-wrap">
					<div class="vue-app-install-page-image">
						<img src="@widget/assets/login/install.svg" alt="">
					</div>
					<h3 class="vue-app-install-page-title">
						Embed social media·to your store for authentic engagement
					</h3>
					<div class="vue-app-install-page-description">
						Set-it-forget-it tool to display Instagram grid on your website.
					</div>
					<div class="vue-app-install-page-action">
						<a-button size="large" type="primary" :loading="is_loading" @click="handleLogin">
							Install app now!
						</a-button>
						<a href="https://apps.shopify.com/social-widget" target="_blank" class="m-l-16 ant-btn ant-btn-lg">
